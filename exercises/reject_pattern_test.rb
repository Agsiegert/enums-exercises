...
class RejectPatternTest < Minitest::Test
  ...
  def test_remove_numbers
    ...
    elements.each do |element|
      not_numbers << element unless element.kind_of? Numeric
    end
  ...
  def test_remove_animals_starting_with_vowels
    ...
    remaining =[]
    animals.each do |animal|
      remaining << animal unless animal.start_with?('a', 'e')
    end
  ...
  def test_remove_arrays
    ...
    remaining = []
    elements.each do |element|
      remaining << element unless element.kind_of? Array
    end
  ...
  def test_remove_hashes
    ...
    remaining = []
    elements.each do |element|
      remaining << element unless element.kind_of? Hash
    end
